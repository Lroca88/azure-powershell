...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Updated storage account identity handling to explicitly use the Storage SDK ''Identity'' model in ''New-AzStorageAccount'' and ''Set-AzStorageAccount''.'
