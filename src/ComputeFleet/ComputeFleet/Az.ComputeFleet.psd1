...
FunctionsToExport = 'Get-AzComputeFleet', 'Get-AzComputeFleetVirtualMachine', 
               'Get-AzComputeFleetVirtualMachineScaleSet', 'New-AzComputeFleet', 
               'Remove-AzComputeFleet', 'Set-AzComputeFleet', 
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added support for ''Launch'' mode in ComputeFleet.
