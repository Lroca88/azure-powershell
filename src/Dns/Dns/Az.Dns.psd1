...
CmdletsToExport = 'Add-AzDnsRecordConfig', 'Get-AzDnsRecordSet', 'Get-AzDnsZone', 
               'New-AzDnsRecordConfig', 'New-AzDnsRecordSet', 'New-AzDnsZone', 
               'Remove-AzDnsRecordConfig', 'Remove-AzDnsRecordSet', 
               'Remove-AzDnsZone', 'Set-AzDnsRecordSet', 'Set-AzDnsZone'
...
PrivateData = @{
    ...
    PSData = @{
        ...
        ReleaseNotes = '* Added support for linking a DNS record set to an Azure Traffic Manager profile (Traffic Manager link, also known as TMLink)
